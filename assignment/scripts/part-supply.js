...
for(supply of supplyChanges) {
    if(supply > 0) console.log('Added', supply, 'parts');
    if(supply === 0) console.log('No Change.');
    else if (supply < 0) console.log('Removed',supply*-1, 'parts')
}
...
while(parts > 7){
    ...
    console.log('boxes:' , box, '. parts leftover:' , parts, '.');